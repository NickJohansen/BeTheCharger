...
program: $(PRG).hex
	chmod 644 $(PRG).hex
	avrdude -v -p $(PROGRAMMER_TARGET) -c usbasp -e -U flash:w:$(PRG).hex 
...
fuse:
	avrdude\avrdude.exe -u -c usbasp -p $(PROGRAMMER_TARGET) -U lfuse:w:0b11110111:m -B 10
	avrdude\avrdude.exe -u -c usbasp -p $(PROGRAMMER_TARGET) -U hfuse:w:0xD9:m -B 10
	avrdude\avrdude.exe -u -c usbasp -p $(PROGRAMMER_TARGET) -U efuse:w:0xFF:m -B 10
